...
import static com.mycompany.oems.HashUtil.hashPassword; 
...
public class Forgotpassword extends javax.swing.JFrame {
    ...
    public static class UserDatabase {
        public static void updatePassword(String email, String hashedPassword) throws Exception {
            Connection con = javaconnect.connectDB();
            
            String sql = "UPDATE data SET password=? WHERE email=?";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            UserDatabase.updatePassword(jTextField1.getText().trim(), hashedPassword);

            JOptionPane.showMessageDialog(this, "Password reset successfully!");
            new SignIN().setVisible(true);
            this.dispose();
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "Failed to reset password: " + ex.getMessage());
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (enteredOTP.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Enter the OTP first!");
            return;
        }
