...
private void loadProfile() {
        try {
            ...
            if (rs.next()) {
                ...
                jTextField6.setText(rs.getString("role"));
            }
    ...
    private void initComponents() {
        ...
        jButton3.setBackground(new java.awt.Color(22, 103, 132));
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(jLabe4, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel3.setBackground(new java.awt.Color(22, 106, 134));
        jPanel3.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        jLabel4.setFont(jLabel4.getFont().deriveFont((jLabel4.getFont().getStyle() & ~java.awt.Font.ITALIC) & ~java.awt.Font.BOLD, jLabel4.getFont().getSize()+88));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      if(con == null){
        JOptionPane.showMessageDialog(this, "DB connection not available!");
        return;
    }
    try {
        String sql = "UPDATE data SET fullname=?, phone=?, password=?, address=? WHERE id=?";
        PreparedStatement pst = con.prepareStatement(sql);
